...
@Component({
   selector: 'app-contract-listbytype-component',
   templateUrl: './contract-listbytype.component.html'
})
export class ContractListByTypeComponent implements OnInit, OnDestroy {
   ...
   constructor(
      ...
      this.activatedRoute.paramMap.subscribe(async params => {
         const id: any = params.get('contractType');
         console.log('Address:', id);


         this.transactions = null;
         this.contractType = id;

         try {

            this.navPath = "../../";
            await this.updateTransactions('/api/query/cirrus/contract/list/' + this.contractType + '/?offset=&limit=' + this.limit);
